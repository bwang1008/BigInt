...
TEST_CASE("Multiplication with 0", "[mul]") {
    BigInt::BigInt x = 0_b;
    BigInt::BigInt y = 12345678901234567890_b;
...
TEST_CASE("Multiplication of medium-sized positives", "[mul]") {
    BigInt::BigInt x = 12345678901234567890_b;
    BigInt::BigInt y = 98765432109876543210_b;
    BigInt::BigInt z = x * y;
...
TEST_CASE("Multiplication of large positives", "[mul]") {
    BigInt::BigInt x{"31415926535897932384626433832795028841971693993751058209749445923"
             "078164062862089986280348253421170679"};
    BigInt::BigInt y{"27182818284590452353602874713526624977572470936999595749669676277"
